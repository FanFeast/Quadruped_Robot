...
pitch = p.addUserDebugParameter("pitch" , -0.10 , 0.10 , 0.)
roll = p.addUserDebugParameter("roll" , -0.10 , 0.10 , 0.)
yaw = p.addUserDebugParameter("yaw" , -0.10 , 0.10 , 0.)
...
Yc = [0,0,0,0]
Zc = [350,350,350,350]
Ynewu, Xnewu,Znewu = Rotation(Xc,Yc,Zc,0,0,10)
...
while True:
    ...
    #Roll Rotation
    for i in range(0,15):
        Ynewu, Xnewu, Znewu = Rotation(Xc,Yc,Zc,0,0,i)
        a1,b1,c1 = legik(Xnewu[0],Ynewu[0],Znewu[0],1)
        a2,b2,c2 = legik(Xnewu[1],Ynewu[1],Znewu[1],2)
        a3,b3,c3 = legik(Xnewu[2],Ynewu[2],Znewu[2],3)
        a4,b4,c4 = legik(Xnewu[3],Ynewu[3],Znewu[3],4)
