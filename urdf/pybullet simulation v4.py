...
def Rotation(Xc,Yc,Zc,yawangle):
    ...
    Yuc = [Yc[0] + (BodyLength/2), Yc[1] + (BodyLength/2), (Yc[2] + (BodyLength/2))*-1, (Yc[3] + (BodyLength/2))*-1]
    Xuc = [(Xc[0] + (BodyWidth/2))*-1, Xc[1] + (BodyWidth/2), (Xc[2] + (BodyWidth/2))*-1, Xc[3] + (BodyWidth/2)]
    ...
    Ynewu = [Ynew[0] - (BodyLength/2), Ynew[1] - (BodyLength/2), Ynew[2]*-1 - (BodyLength/2), Ynew[3]*-1 - (BodyLength/2)]
    Xnewu = [Xnew[0]*-1 - (BodyWidth/2), Xnew[1] - (BodyWidth/2), Xnew[2]*-1 - (BodyWidth/2), Xnew[3] - (BodyWidth/2)] 
    return Ynewu, Xnewu
    
Ynewu, Xnewu = Rotation(Xc,Yc,Zc,30)
a1,b1,c1 = legik(Xnewu[0],Ynewu[0],Zc[0])
a2,b2,c2 = legik(Xnewu[1],Ynewu[1],Zc[1])
a3,b3,c3 = legik(Xnewu[2],Ynewu[2],Zc[2])
a4,b4,c4 = legik(Xnewu[3],Ynewu[3],Zc[3])
...
quad = p.loadURDF("quadf.urdf",startPos, startOrientation,useFixedBase=True)
